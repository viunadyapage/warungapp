...
// import '../auth/login_screen.dart'; // 👈 JANGAN LUPA IMPORT HALAMAN LOGIN KAMU
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // HEADER (Diedit untuk menambahkan Logout)
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const Text(
                          "WarungKu App",
                          style: TextStyle(
                            fontSize: 24, // Sedikit disesuaikan agar muat
                        ...
                        // Row untuk Tombol Profil & Logout
                        Row(
                          children: [
                            // 1. TOMBOL PROFIL
                            InkWell(
                              ...
                              child: _headerIconButton(Icons.person),
                            ),
                            ...
                            InkWell(
                              ...
                              child: _headerIconButton(Icons.logout_rounded, isLogout: true),
                            ),
                          ],
                        )
                      ],
